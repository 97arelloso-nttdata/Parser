...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    file_system_client = datalake_service_client.get_file_system_client("smp/raw_data")
    file_client = datalake_service_client.get_file_client(file_system_client.file_system_name, "TA02_H_20210924_MEDIDAS.MED")
    ...
    smp_class = MEDData("C://Users/arelloso/Downloads/TA01_H_20210924_MEDIDAS.MED")
    ...
    smp_csv = smp.to_csv("csv/prueba_local")
    ...
    file_system_client = service_client_sink.get_file_system_client(file_system="smp")
    directory_client_sink = file_system_client.get_directory_client("processed_data")
    file_client_sink = directory_client_sink.create_file("uploaded-file.csv")

    local_file = open("csv/prueba_local",'r')
    ...
    return func.HttpResponse(f"End")